...
func CreateTextInputBlock(aID ActionID, bID BlockID, name string, placeholder string, emoji bool, verbatim bool) *slack.InputBlock {
...
func CreateTextWorkflowStepInput(blockAction BlockActionValues, aID ActionID, bID BlockID, skipVariableReplacement bool) *slack.WorkflowStepInputs {
